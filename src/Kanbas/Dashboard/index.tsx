...
import { setCourse, addCourse, deleteCourse, updateCourse } from "../Courses/courseReducer";
...
const Dashboard = () => {
    ...
    const course = useSelector((state : CourseState) => state.coursesReducer.course);
        ...
        <div className="col ms-5 ms-lg-3 container ms-0 me-0 main-content">
            ...
            {editMode ? (
                ...
                <div>
                    ...
                    <div className="row">
                        <div className="course-add ps-0 border rounded">
                            <div className="row">
                            ...
                            {courses.map((course, index) => (
                                <div className="card dash-card">
                                    ...
                                    <Link key={course._id} to={`/Kanbas/Courses/${course._id}`} className="text-link">
                                        <img src="/images/course.jpg" className="card-img-top" alt="Course Image" />
                                    </Link>
